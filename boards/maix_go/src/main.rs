...
pub unsafe fn reset_handler() {
    ...
    let chip = static_init!(k210::chip::ArtyExx, k210::chip::ArtyExx::new());
    chip.initialize();
    ...
    kernel::debug::assign_gpios(
        Some(&k210::gpio::PORT[0]), // Red
        Some(&k210::gpio::PORT[1]),
        Some(&k210::gpio::PORT[8]),
    );
    ...
    hil::uart::Transmit::set_transmit_client(&k210::uart::UART0, uart_mux);
    hil::uart::Receive::set_receive_client(&k210::uart::UART0, uart_mux);
    ...
    let button_pins = static_init!(
        ...
        [(
            static_init!(
                ...
                kernel::hil::gpio::InterruptValueWrapper::new(&k210::gpio::PORT[4])
            )
            .finalize(),
    ...
    let gpio_pins = static_init!(
        ...
        [
            static_init!(
                kernel::hil::gpio::InterruptValueWrapper,
                kernel::hil::gpio::InterruptValueWrapper::new(&k210::gpio::PORT[7])
            )
            .finalize(),
            static_init!(
                kernel::hil::gpio::InterruptValueWrapper,
                kernel::hil::gpio::InterruptValueWrapper::new(&k210::gpio::PORT[5])
            )
            .finalize(),
            static_init!(
                kernel::hil::gpio::InterruptValueWrapper,
                kernel::hil::gpio::InterruptValueWrapper::new(&k210::gpio::PORT[6])
            )
            .finalize(),
        ]
    );
    ...
    // k210::uart::UART0.initialize_gpio_pins(&k210::gpio::PORT[17], &k210::gpio::PORT[16]);
